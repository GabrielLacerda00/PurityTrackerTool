...
public class methodVerifierLeft {
...
//                "soma");
    ...
    public static String verifyMethod(String javaFilePath, String methodName) {
        ...
        try (FileInputStream in = new FileInputStream(javaFilePath)) {
            ...
            org.example.util.methodVerifierLeft.MethodVisitor methodVisitor = new org.example.util.methodVerifierLeft.MethodVisitor(methodName);
