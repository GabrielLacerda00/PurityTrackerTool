...
public class expectedGumTreeObj {
    ...
    public expectedGumTreeObj(String type, String lineOrigin, String nameMethodOrigin, String lineDest, String nameMethodDst) {
        this.type = type;
    ...
    public expectedGumTreeObj(String type) {
        this.type = type;
    }
